...
<jsp:include page="../common/header.jsp"></jsp:include>
 <div class="breadcrumbs">
    	<div class="container">
        	<a href="${pageContext.request.contextPath}">首页</a><span>/</span><a href="javascript:void(0);">投资理财</a><span>/</span>理财产品
...
<script>
  $(function () {
    ...
    var dataTable=$('#example1').DataTable({
		...
		"bServerSide" : true,
		"searching" : false,
		"sAjaxSource" : "${pageContext.request.contextPath}/finance/prodList",
		...
		"aoColumns" : [ {
			...
			//console.log(row);
			var param=row.id;
			var html= '<a href="${pageContext.request.contextPath}/finance/product/purchase?id='+param+'" class="btn btn-primary btn-sm"  > 购买</a>';
			return html;
			}
			}],
	//visible-设置列不可见		

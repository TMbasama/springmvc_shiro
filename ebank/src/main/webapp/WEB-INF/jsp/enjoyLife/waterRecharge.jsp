...
<body>
    ...
    <ul class="bzzx_nav_list">
      <li class="on"> <a href="${pageContext.request.contextPath}/enjoyLife/waterRecharge" class="icon_1"><i class="fa fa-tint" style="margin-right:32px; color:#209FC4"></i>水费</a> </li>
  ...
  <div class="fw_conent"> 
    <!--内容开始------------------------------>
    <div class="bzzx_bt"> <strong><i class="fa fa-tint" style="margin-right:10px; color:#209FC4"></i>水费</strong></div>
		...
		<div class="container-fluid">
			<div class="carousel slide" data-ride="carousel"
				...
				<div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
						<form id="defaultForm1" method="post" class="form-horizontal">
                            <div class="form-group">
								<label class="col-lg-4 control-label">水费账号：</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="water_acct_id" name="water_acct_id" />
								</div>
							</div>
							<div class="form-group">
					...
					<div class="item">
						<form id="defaultForm2" method="post" class="form-horizontal">
                            <div class="form-group">
								<label class="col-lg-4 control-label">水费账号：</label>
								<div class="col-lg-5">
									<p class="text-center" id="water_acct_id_1" name="water_acct_id_1"></p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-4 control-label">缴纳金额：</label>
					...
					<div class="item">
					    <div class="container">
						<h2 style="margin-left:25%;"><i class="fa fa-check-circle ebank-check" ></i>恭喜您，缴纳水费成功！</h2>
						...
						<button type="button" class="btn btn-block btn-success btn-sm" style="text-align: center;" onclick="location.href='/ebank/user/profile'">个人中心</button>
						</div>
			...
			$("#next").click(function() {
        				         	        ...
        				         	        success : function(data){
        				         	        	if(data.code=="0000"){
        				         	        	   ...
        				         	        	   $("#myModalNext .carousel").carousel('next');
        	      				                   ...
        	      				                   $("#next").text("确定");
        	      				                   $("#water_acct_id_1").text($("#water_acct_id").val());
            	 ...
            	 case 2:
            		console.log($("#myModalNext .step .active").length );
                  		...
                  		$.ajax({
			         	        type :'POST',
			         	        url : '${pageContext.request.contextPath}/enjoyLife/payWater',
			         	        data : $("#defaultForm1").serialize(),
			         	        dataType : "json",
			         	        success : function(data){
			         	        	if(data.code=="0000"){
     				                   ...
     				                   $(".modal-footer").hide();
			         	        		...
			         	        		layer.msg("缴纳水费失败",{icon: 5},function(){});

...
<body>
    ...
    <ul class="bzzx_nav_list">
      ...
      <li class="on"> <a href="${pageContext.request.contextPath}/enjoyLife/gasRecharge" class="icon_3"><i class="fa fa-fire" style="margin-right:25px;color:#FF7A18;"></i>燃气费</a> </li>
  ...
  <div class="fw_conent"> 
    <!--内容开始------------------------------>
    <div class="bzzx_bt"> <strong><i class="fa fa-fire" style="margin-right:10px; color:#FF7A18"></i>燃气费</strong></div>
		...
		<div class="container-fluid">
			<div class="carousel slide" data-ride="carousel"
				...
				<div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
						<form id="defaultForm1" method="post" class="form-horizontal">
                            <div class="form-group">
								<label class="col-lg-4 control-label">燃气费账号：</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="gas_acct_id" name="gas_acct_id" />
								</div>
							</div>
							<div class="form-group">
					...
					<div class="item">
						<form id="defaultForm2" method="post" class="form-horizontal">
                            <div class="form-group">
								<label class="col-lg-4 control-label">燃气费账号：</label>
								<div class="col-lg-5">
									<p class="text-center" id="gas_acct_id_1" name="gas_acct_id_1"></p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-4 control-label">缴纳金额：</label>
					...
					<div class="item">
					    <div class="container">
						<h2 style="margin-left:25%;"><i class="fa fa-check-circle ebank-check" ></i>恭喜您，缴纳燃气费成功！</h2>
			...
			$("#next").click(function() {
        				         	        ...
        				         	        success : function(data){
        				         	        	if(data.code=="0000"){
        				         	        	   ...
        				         	        	   $("#myModalNext .carousel").carousel('next');
        	      				                   ...
        	      				                   $("#next").text("确定");
        	      				                   $("#gas_acct_id_1").text($("#gas_acct_id").val());
            	 ...
            	 case 2:
            		console.log($("#myModalNext .step .active").length );
                  		...
                  		$.ajax({
			         	        type :'POST',
			         	        url : '${pageContext.request.contextPath}/enjoyLife/payGas',
			         	        data : $("#defaultForm1").serialize(),
			         	        dataType : "json",
			         	        success : function(data){
			         	        	if(data.code=="0000"){
     				                   ...
     				                   $(".modal-footer").hide();
			         	        		...
			         	        		layer.msg("缴纳燃气费失败",{icon: 5},function(){});

...
<body>
	...
	<div id="myModalNext">
		...
		<label>产品名称：</label>
		<a style="font-weight:bold; color:#337AB7">${fundProd.name }</a>
			...
			<div class="carousel slide" data-ride="carousel"
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<form id="defaultForm1" method="post" class="form-horizontal">
						    <div class="form-group">
						 		<label class="col-lg-4 control-label">基金代码</label>
						 		<div class="col-lg-5">
									<p class="text-center">${fundProd.code }</p>
								</div>	
							</div>
							<div class="form-group">
						 		<label class="col-lg-4 control-label">交易类型</label>
						 		<div class="col-lg-5">
									<p class="text-center">申购</p>
								</div>	
							</div>
							<div class="form-group">
						 		<label class="col-lg-4 control-label">购买金额</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="hold_price" name="hold_price" />
								</div>
								<div class="ebank-form-mid ebank-word-aux">首次购买：1000元起</div>
							</div>
						    <div class="form-group">
						 		<label class="col-lg-4 control-label">币种</label>
								<div class="col-lg-5">
									<p class="text-center">${fundProd.currency }</p>
								</div>
							</div>
							<div class="form-group">
					...
					<div class="item">
						<form id="defaultForm2" method="post" class="form-horizontal">
							...
							<div class="form-group">
						 		<label class="col-lg-4 control-label">购买金额</label>
								<div class="col-lg-5">
									<p id="hold_price_1" class="text-center"></p>
								</div>
							</div>
						    <div class="form-group">
						 		<label class="col-lg-4 control-label">币种</label>
							...
							<div class="form-group">
						 		<label class="col-lg-4 control-label">储蓄账户</label>
								<div class="col-lg-5">
									<p id="acct_id_1" class="text-center"></p>
								</div>
							</div>
							<div class="form-group">
					...
					<div class="item" style="height:400px">
						...
						<p style="text-align:center;margin-left:60px;">您可以到我的基金查看您购买的理财产品。</p>
						...
						<div class="btn-group btn-group-justified" role="group" style="margin-top:100px">
                               ...
                               <div class="btn-group" role="group">
                               <button type="button" class="btn btn-success btn-sm" onclick="location.href='${pageContext.request.contextPath}/fund/myfund'">我的基金</button>
                               </div>
                               <div class="btn-group" role="group">
                               </div>
                        </div>
...
//			        live: 'disabled',
			...
			$("#next").click(function() {
                 		...
                 		$.ajax({
		         	        ...
		         	        success : function(data){
		         	        	if(data.code=="0000"){
			            	       ...
			            	       $("#hold_price_1").text($("#hold_price").val());
		         	        	}else{
            	 ...
            	 case 2:
      			     $.ajax({
      				 type :'POST',
      				 url : '${pageContext.request.contextPath}/fund/product/buyProd',

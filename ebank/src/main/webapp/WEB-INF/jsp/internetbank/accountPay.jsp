...
<!-- 					<div class="item">
					...
					<div class="item" style="height:400px">
					    <div class="container">
						<h2 style="text-align:center"><i class="fa fa-check-circle ebank-check" ></i>恭喜您，开通账户支付成功！</h2>
						<p style="text-align:center;margin-left:60px;">无需开通账户支付即可支付，简便快捷</p>
			...
			$("#next").click(function() {
            	 ...
            	 case 2:
            		console.log($("#myModalNext .step .active").length );
                  		...
                  		$.ajax({
			         	        type :'POST',
			         	        url : '${pageContext.request.contextPath}/internetbank/applyAccountPay',
			         	        data : $("#defaultForm1").serialize(),
			         	        dataType : "json",
			         	        success : function(data){
			         	        	if(data.code=="0000"){
     				                   ...
     				                   $(".modal-footer").hide();
			         	        		...
			         	        		layer.msg("开通账户支付失败",{icon: 5},function(){});

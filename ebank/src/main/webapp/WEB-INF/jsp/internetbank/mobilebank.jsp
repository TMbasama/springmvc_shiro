...
<!-- 					<div class="item">
					...
					<div class="item" style="height:400px">
					    <div class="container">
						<h2 style="text-align:center"><i class="fa fa-check-circle ebank-check" ></i>恭喜您，开通手机银行成功！</h2>
						<p style="text-align:center;margin-left:60px;">登录手机客户端可以享受账户查询、投资理财、信用卡、生活缴费等服务</p>
			...
			$("#next").click(function() {
            	 ...
            	 case 2:
            		console.log($("#myModalNext .step .active").length );
                  		...
                  		$.ajax({
			         	        type :'POST',
			         	        url : '${pageContext.request.contextPath}/internetbank/applyMoblieBank',
			         	        data : $("#defaultForm1").serialize(),
			         	        dataType : "json",
			         	        success : function(data){
			         	        	if(data.code=="0000"){
     				                   ...
     				                   $(".modal-footer").hide();
			         	        		...
			         	        		layer.msg("开通手机银行失败",{icon: 5},function(){});

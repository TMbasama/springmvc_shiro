...
public final class prod_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t<a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">首页</a><span>/</span><a href=\"javascript:void(0);\">投资理财</a><span>/</span>基金交易\r\n");
      ...
      out.write("\t\t\t\"sTitle\" : \"币种\"\r\n");
      out.write("\t\t}, {\r\n");
      out.write("\t\t\t\"data\" : \"curr_price\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"最新净值\"\r\n");
      out.write("\t\t}, {\r\n");
      out.write("\t\t\t\"data\" : \"curr_price\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"净值日期\"\r\n");
      out.write("\t\t}  ,{\r\n");
      out.write("\t\t\t\"data\" : \"near_oneday\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"近一日\"\r\n");
      out.write("\t\t}  ,{\r\n");
      out.write("\t\t\t\"data\" : \"near_onemouth\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"近一月\"\r\n");
      out.write("\t\t},{\r\n");
      out.write("\t\t\t\"data\" : \"near_threemouth\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"近三月\"\r\n");
      out.write("\t\t} ,{\r\n");
      out.write("\t\t\t\"data\" : \"near_sixmouth\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"近六月\"\r\n");
      out.write("\t\t} ,{\r\n");
      out.write("\t\t\t\"data\" : \"near_oneyear\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"近一年\"\r\n");
      out.write("\t\t}  , {\r\n");
      out.write("\t\t\t\"data\" : \"rate\",\r\n");
      out.write("\t\t\t\"sTitle\" : \"银河三年评级\"\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t},{\r\n");
      out.write("\t\t\t// 定义操作列\r\n");
      ...
      out.write("\t\t\tvar html= '<a href=\"javascript:void(0);\"  class=\"btn btn-primary btn-sm\"  > 购买</a>'+'&nbsp;&nbsp;';\r\n");
      out.write("\t\t\thtml += '<a href=\"javascript:void(0);\" onclick=\"editDept(\\''+param+'\\')\" class=\"btn btn-primary btn-sm\"></i> 定投</a>';\r\n");
      ...
      out.write("\t\t\t           \"render\": function ( data, type, row ) {\r\n");
      out.write("\t\t\t        \t          if(data==1){\r\n");
      out.write("\t\t\t                        return '<p class=\"header\">股票型</b>';\r\n");
      out.write("\t\t\t        \t          }else if(data==2){\r\n");
      out.write("\t\t\t        \t        \treturn '<p class=\"header\">QDII</b>';  \r\n");
      out.write("\t\t\t        \t          }else if(data==3){\r\n");
      out.write("\t\t\t        \t        \t  return '<p class=\"header\">混合型</b>';  \r\n");
      out.write("\t\t\t        \t          }\r\n");
      out.write("\t\t\t             },\r\n");
      out.write("\t\t\t                    \"targets\": 2\r\n");
      out.write("\t\t\t                },\r\n");
      ...
      out.write("\t\t\t           \"render\": function ( data, type, row ) {\r\n");
      out.write("\t\t\t        \t            if(data==-1){\r\n");
      out.write("\t\t\t        \t            \treturn '<p class=\"text-center\">-</p>';\r\n");
      out.write("\t\t\t        \t            }\r\n");
      out.write("\t\t\t        \t            if(data>0){\r\n");
      out.write("\t\t\t\t                    return '<p class=\"text-center table-data-up\">'+data+'%</p>';\r\n");
      out.write("\t\t\t        \t            }\r\n");
      out.write("\t\t\t                        return '<p class=\"text-center table-data-down\">'+data+'%</p>';\r\n");
      out.write("\t\t\t             },\r\n");
      out.write("\t\t\t                    \"targets\": [4,5,6,7,8,9,10]\r\n");
      out.write("\t\t\t                },\r\n");
      out.write("\t\t\t         {\r\n");
      out.write("\t\t\t           \"render\": function ( data, type, row ) {\r\n");
      out.write("\t\t\t        \t            if(data==-1){\r\n");
      out.write("\t\t\t                        return '<p class=\"text-center\">暂无评级</p>';\r\n");
      out.write("\t\t\t        \t            }else{\r\n");
      out.write("\t\t\t        \t            \tvar temp='<p class=\"text-center\"><i class=\"fa fa-star\"></i>';\r\n");
      out.write("\t\t\t        \t            \tfor(var i=1;i<data;i++){\r\n");
      out.write("\t\t\t        \t            \t\ttemp+='<i class=\"fa fa-star\"></i>';\r\n");
      out.write("\t\t\t        \t            \t}\r\n");
      out.write("\t\t\t        \t            \ttemp+='</p>';\r\n");
      ...
      out.write("\t\t\t                },\r\n");
      out.write("\t\t\t         {\"bSortable\": false,\"targets\": [12]}\r\n");
      out.write("\t\t\t            ],\t\r\n");
      out.write("\t\t\"language\" : {\r\n");

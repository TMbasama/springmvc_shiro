...
public class UserServiceImplTest {
	...
	public void testRegister() {
		 UserInfo user=new UserInfo(null, "test1", "ffffff", "1234","男", "15070080863", "tmbasama@160.com",11,111,"tan",null,"tan",null,null);
		try {
	...
	public void testUpdateUserInfo() {
		...
		try {
			UserInfo userInfo=service.findUserInfoByName("test");
	...
	public void testDeleteUserInfo() {
		try {
			assertEquals(true,service.deleteUserInfoById("tan", "test"));
		} catch (UserServiceException e) {

	...
	*/
	var rl_exp = {
		...
		text:[			/*表情包title文字，自己补充*/
			[
				'http://localhost:8888/clps_mms_201701/images/icon/bubble.ico','http://localhost:8888/clps_mms_201701/images/icon/bug.ico','http://localhost:8888/clps_mms_201701/images/icon/card.ico','http://localhost:8888/clps_mms_201701/images/icon/clock.ico',
				'http://localhost:8888/clps_mms_201701/images/icon/cup.ico','http://localhost:8888/clps_mms_201701/images/icon/date.ico','http://localhost:8888/clps_mms_201701/images/icon/drawer.ico','http://localhost:8888/clps_mms_201701/images/icon/folder.ico',
				'http://localhost:8888/clps_mms_201701/images/icon/gear.ico','http://localhost:8888/clps_mms_201701/images/icon/globe.ico','http://localhost:8888/clps_mms_201701/images/icon/heart.ico','http://localhost:8888/clps_mms_201701/images/icon/help.ico',
				'http://localhost:8888/clps_mms_201701/images/icon/inbox.ico','http://localhost:8888/clps_mms_201701/images/icon/info.ico','http://localhost:8888/clps_mms_201701/images/icon/leaf.ico','http://localhost:8888/clps_mms_201701/images/icon/lock.ico'
				/*'','测试','测试','测试',
		...
		bind:	function(i){
			$("#rl_bq .rl_exp_main").eq(i).find('.rl_exp_item').each(function(){
				$(this).bind('click',function(){
					$("#m_image").val("");
					rl_exp.insertText(document.getElementById('m_image'),$(this).find('img').attr('title'));

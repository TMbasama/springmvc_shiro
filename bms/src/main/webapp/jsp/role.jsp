                        ...
                        <div class="layui-form search">
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input class="layui-input" id="name" name="name" placeholder="角色名称">
                                </div>
                            </div>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
		...
		<script type="text/html" id="tpl">
			...
			<tr>
                ...
                <td>
					...
					<a href="javascript:;" data-id="{{ item.id }}" data-name="{{ item.name }}" data-opt="settingMenu" class="layui-btn layui-btn-normal layui-btn-mini">设置菜单</a>
				</td>
			</tr>
			{{# }); }}
		</script>
				...
				var p=paging.init({
					...
					complate: function() { //完成的回调
						...
						$('#content').children('tr').each(function() {
							var $that = $(this);
						//绑定所有设置菜单按钮事件						
							$that.children('td:last-child').children('a[data-opt=settingMenu]').on('click', function() {
								var id=$(this).data('id');

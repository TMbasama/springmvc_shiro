...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("                                    <input class=\"layui-input\" id=\"name\" name=\"name\" placeholder=\"角色名称\">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"layui-inline\">\r\n");
      out.write("                                <div class=\"layui-input-inline\">\r\n");
      ...
      out.write("\t\t\t\t\t<a href=\"javascript:;\" data-id=\"{{ item.id }}\" data-name=\"{{ item.name }}\" data-opt=\"settingMenu\" class=\"layui-btn layui-btn-normal layui-btn-mini\">设置菜单</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t{{# }); }}\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t$that.children('td:last-child').children('a[data-opt=settingMenu]').on('click', function() {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tcontent: 'configMenu.jsp?id='+id,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t//area: ['1300px', '650px'],\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfix: true, //不固定\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcontent: 'updateRole.jsp?id='+id,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tend:function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tp.get();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\t\r\n");

...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("                            <div class=\"layui-inline\">\r\n");
      out.write("                                <div class=\"layui-input-inline\">\r\n");
      out.write("                                    <input class=\"layui-input\" id=\"name\" name=\"name\" placeholder=\"产品名称\">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"layui-inline\">\r\n");
      out.write("                                <div class=\"layui-input-inline\">\r\n");
      out.write("                                    <input class=\"layui-input\"  onkeyup=\"value=value.replace(/[^\\d]/g,'')\" id=\"price\" name=\"price\" placeholder=\"价格\">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"layui-inline\">\r\n");
      out.write("                                <div class=\"layui-input-inline\">\r\n");
      out.write("                                    <input class=\"layui-input\" onkeyup=\"value=value.replace(/[^\\d]/g,'')\" id=\"uniqueNum\" name=\"uniqueNum\" placeholder=\"产品编号\">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"layui-inline\">\r\n");
      ...
      out.write("\t\t\t\t<td width=\"80px\" height=\"50px\"><img  class= ' image ' src='{{ item.reImage}}' width=\"100%\" height=\"100%\"></td>\r\n");
      out.write("\t\t\t\t<td>{{ item.price }}</td>\r\n");
      out.write("\t\t\t\t<td>{{ item.uniqueNum }}</td>\r\n");
      out.write("                <td>\r\n");
      out.write("\t\t\t\t\t<a href=\"detail-img.jsp?id={{item.id}}\" target=\"_blank\" class=\"layui-btn layui-btn-normal layui-btn-mini\">预览</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t{{# }); }}\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\t\t\t\t\tvar uniqueNum=$(\"#uniqueNum\").val();\r\n");
      out.write("\t\t\t\t\tp.get({\r\n");
      out.write("\t\t\t\t\t\turl:\"../product/view\", //地址\r\n");
      out.write("\t\t\t\t\t\telem: '#content', //内容容器\r\n");
      out.write("\t\t\t\t\t\tpageWhere1:name,\r\n");
      out.write("\t\t\t\t\t\tpageWhere2:price,\r\n");
      out.write("\t\t\t\t\t\tpageWhere3:uniqueNum,\r\n");
